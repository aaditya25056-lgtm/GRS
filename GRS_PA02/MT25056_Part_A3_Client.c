/* * Roll No: MT25056 
 * Part A3: Zero-Copy Client with Throughput/Latency Measurement
 */
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
...
void *client_worker(void *args) {
    ...
    printf("[Client] Connected to A3 Server! Receiving...\n");
...
int main(int argc, char *argv[]) {
    ...
    double avg_lat = global_iterations > 0 ? (global_latency / global_iterations) : 0;
